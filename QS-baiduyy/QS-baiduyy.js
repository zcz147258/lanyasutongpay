...
function getBDVoicToken() {
	return new Promise((rs, rj) => {
		...
		uni.request({ // 强烈建议此接口由后端访问并且维护token有效期，否则前端每次访问都会刷新token
			...
			url: 'https://openapi.baidu.com/oauth/2.0/token?grant_type=client_credentials&client_id=NuniQzfw4H8hjWEy6ecj49yO&client_secret=l5RwHN1E7jmnBrYPIz4kv3EBuOUlG5hV',
			...
			// data: 'grant_type=client_credentials&client_id=uFYiXWMCiYvx68V4EVyCGeL8j4GAzXD5&client_secret=897Mm2qCj7bC1eHYVDxaWrO38FscTOHD',
			header: {
